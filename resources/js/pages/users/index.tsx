...
import { BreadcrumbItem, PagePropsUserList } from '@/types';
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                ...
                                <h1 className="text-base font-bold tracking-tight text-foreground font-mono uppercase">
                                    Daftar Personel & Hak Akses Pengguna
                                </h1>
                            </div>
                            <p className="text-xs text-muted-foreground mt-0.5">
                                Pengaturan akun operator, teknisi lapangan, dan administrator sistem
                            </p>
                        </div>
