...
import { BreadcrumbItem, PagePropsKerusakanList } from '@/types';
...
export default function Index() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Manajemen Kerusakan" />
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-border/50">
                        <div>
                            <div className="flex items-center gap-2">
                                ...
                                <h1 className="text-base font-bold tracking-tight text-foreground font-mono uppercase">
                                    Log Pelaporan Kerusakan Mesin
                                </h1>
                            </div>
                            <p className="text-xs text-muted-foreground mt-0.5">
                                Tiket insiden kerusakan mesin yang memerlukan penanganan teknisi
                            </p>
                        </div>
                        ...
                        <div className="flex items-center gap-2.5">
                            <div className="relative w-full sm:w-64">
                                ...
                                <Input
                                    type="text"
                                    placeholder="Cari deskripsi / kode mesin..."
                                    value={search}
