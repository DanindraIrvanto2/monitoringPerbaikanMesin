...
export default function Index() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Manajemen Perbaikan" />
                ...
                <div className="rounded-lg border border-border bg-card p-4 sm:p-5 shadow-xs space-y-4">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-border/50">
                        <div>
                            <div className="flex items-center gap-2">
                                ...
                                <h1 className="text-base font-bold tracking-tight text-foreground font-mono uppercase">
                                    Antrean Tugas Perbaikan Aktif
                                </h1>
                            </div>
                            <p className="text-xs text-muted-foreground mt-0.5">
                                Tiket penugasan perbaikan yang sedang dalam pengerjaan oleh teknisi
                            </p>
                        </div>
                        ...
                        <div className="relative w-full sm:w-64">
                            ...
                            <Input
                                type="text"
                                placeholder="Cari unit / tindakan..."
                                value={search}
                    ...
                    {/* Data Table */}
                    <DataTablePerbaikan columns={columnsPerbaikan} data={perbaikan} />
                </div>
            </div>
        </AppLayout>
    );
